...
<!-- MENUBAR SECTION BEGINS -->
<header class="header">
        <div class="top-row">
            <div class="container">
                <div class="row nav-flex">
                    <div class="col-md-6 col-xs-12">
                        <div class="logo_sec_txt_list">
                         <ul>
                           ...
                           <li><a href="maitlto:{{App\Http\Traits\HelperTrait::returnFlag(218) }}"><i class="fa fa-envelope" aria-hidden="true"></i> {{App\Http\Traits\HelperTrait::returnFlag(218) }}</a></li>
                         </ul>
                       </div>
                                    </div>
                                    <div class="col-md-6 col-xs-12">
              ...
              <div class="user_img">
               <a href="#">
               <img src="{{asset('images/user.png')}}" alt="image" class="img-responsive">
               <div class="user_img1">
                <a href="#" data-toggle="modal" data-target="#myModal">Login / Register</a>
               </div>
                </a>
             </div>
              <div class="logo_sec_txt12">
                <div class="wrapper">
                      ...
                      <div class="bottom-row">
                          <div class="container">
                            ...
                            <div class="mobile-nav">
                                ...
                                <div class="mobile-body"><ul class="mobile-nav-items">
                                        <li class="active"><a href="{{route('home')}}">Home</a></li>
                                <li><a href="{{route('aboutUs')}}">About Us</a></li>
                                <li><a href="{{route('find_your_coach')}}">Find Your Coach</a></li>
                            </ul><ul class="mobile-nav-items">
                            <li><a href="{{route('become_a_coach')}}">Become a Coach</a></li>
                    ...
                    <div class="col-md-6 hidden-sm hidden-xs pull-right">
                        <div class="navigation-list float-r">
                            <ul class="list-inline">
                                ...
                                <li><a href="{{route('videos')}}">Videos</a></li>
                                <li><a href="{{route('contact_us')}}">Contact Us</a></li>
                                <li><a href="{{route('purchasing_membership')}}" class="new_one_buttn">Get Started</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
