    ...
    <div class="container-fluid bg-white mt-5">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card-body">
                    <h3 class="box-title pull-left">Coach</h3>
                    
                        <a class="btn btn-success pull-right" href="{{ url('/admin/coach/create') }}"><i
                                    class="icon-plus"></i> Add Coach</a>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('/admin/coach/' . $item->id) }}"
                                            ...
                                            <a href="{{ url('/admin/coach/' . $item->id . '/edit') }}"
                                               title="Edit Coach">
