<div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('name') ? 'has-error' : ''}}">
...
</div><div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('long_detail') ? 'has-error' : ''}}">
    {!! Form::label('long_detail', 'Long Detail', ['class' => 'col-md-12 control-label']) !!}
    <div class="col-md-12">
        {!! Form::textarea('long_detail', null, ('required' == 'required') ? ['class' => 'form-control', 'id' => 'summary-ckeditor1', 'required' => 'required'] : ['class' => 'form-control']) !!}
        {!! $errors->first('long_detail', '<p class="help-block">:message</p>') !!}
    </div>
    ...
    <div class="col-md-12">
        ...
        src="{{ isset($coach)?asset($coach->image):asset('images/upload.jpg') }}" style="width: 30%;"> 
        <br/>
        </div>
        <br/>
