<div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('video_title') ? 'has-error' : ''}}">
    {!! Form::label('video_title', 'Video Title', ['class' => 'col-md-12 control-label']) !!}
    <div class="col-md-12">
        {!! Form::text('video_title', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
