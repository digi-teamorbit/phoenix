            ...
            <div class="col-sm-12">
                ...
                <div class="card-body">
                    <h3 class="box-title pull-left">Package</h3>
                        ...
                        <a class="btn btn-success pull-right" href="{{ url('/admin/package/create') }}"><i
                    ...
                    <div class="table-responsive">
                        <table class="table color-table table-bordered product-table table-hover dataTable no-footer" role="grid" aria-describedby="myTable_info" id="myTable">
                            ...
                            <tr class="text-center">
                                <th>#</th>
                                <th>Package Name</th><th>Title</th>
                                <th>Actions</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($package as $item)
                                <tr class="text-center">
                                    <td>{{ $item->id }}</td>
                                    <td>{{ $item->package_name }}</td><td>{{ $item->title }}</td>
                                    <td>
