...
Route::get('/become-a-coach','HomeController@becomeAcoach')->name('become_a_coach');
Route::get('/contactus','HomeController@contactUs')->name('contact_us');
Route::get('/find-your-coach','HomeController@findYourCoach')->name('find_your_coach');
Route::get('/find-your-coach/{coach}','HomeController@findYourCoachDetail')->name('find_your_coach_detail');
Route::get('/privacy-policy','HomeController@privacyPolicy')->name('privacy_policy');
Route::get('/purchasing-membership','HomeController@purchasingMembership')->name('purchasing_membership');
Route::get('/terms-and-condition','HomeController@termsAndCondition')->name('terms_and_condition');
...
Route::post('weightlosstips_submit','HomeController@weightlosstipsSubmit')->name('weightlosstipsSubmit');
Route::post('freetrial_submit','HomeController@freetrialSubmit')->name('freetrialSubmit');
...
Route::resource('admin/coach', 'Admin\\CoachController');
